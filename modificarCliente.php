...
$cliente = $funciones->getClienteXID($idCliente);


echo "<table class='table table-hover table-responsive table-bordered'>";
//echo "<div class='usuario-id' id='usuario-id' value='{$idUsuario}' >{$idUsuario}</div>";//style='display:none;'
echo "<input type='text' id='usuario-id' name='usuario-id' value='{$idCliente}' style='display:none;' class='form-control' />";
echo "<tr>";
...
echo "<tr>";
echo "<td>";
echo "<button class='btn btn-success modificarCliente'>";
echo "<span class='glyphicon glyphicon-shopping-cart'></span>Modificar Cliente";
echo "</button>";
echo "</td>";
echo "</tr>";
