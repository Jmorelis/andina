...
// page headers
$page_title = "Administrador de Productos";
include 'head.php';
...
<!--<table class='table  table-hover table-responsive ' name=productosGrid>-->
        <div class="col_one_third">
            <div class="feature-box fbox-center fbox-effect">
                <div class="fbox-icon ">
                    <a href="agregarProducto.php"><i class="icon-file-add i-alt "></i></a>
                </div>
                <h3>Agregar Producto</h3>
                <p>Agregar nuevo producto a la base de datos.</p>
            </div>
        </div>
        <div class="col_one_third">
            <div class="feature-box fbox-center fbox-effect">
                <div class="fbox-icon ">
                    <a href="modificarProductos.php"><i class="icon-tasks i-alt "></i></a>
                </div>
                <h3>Modificar o Quitar Productos</h3>
                <p>Modifica o Elimina productos de la base de datos.</p>
            </div>
        </div>
        <!--</table>-->
    </div>
