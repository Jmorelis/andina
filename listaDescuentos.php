...
//} else {
   $listaClientes = $funciones->getAllListaDesc();
...
foreach ($listaClientes as $usuario) {
    ...
    echo "<button class='button button-mini modDescuento' type='button'>Modificar Datos</button>";
    echo "<button class='btn btn-danger cambiarEstadoDescuento' type='button'>Cambiar Estado</button></a>";
    echo "</span>";
    echo "</td>";
    echo "</tr>";
}
